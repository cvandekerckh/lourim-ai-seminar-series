...
\fill[phaseFind!8, rounded corners=5pt] (-0.20, -1.65) rectangle (4.55, 1.55);
\fill[phaseUnderstand!8, rounded corners=5pt] (4.75, -1.65) rectangle (9.50, 1.55);
\fill[phaseCreate!8, rounded corners=5pt] (9.70, -1.65) rectangle (16.55, 1.55);

% --- Phase labels ---
\node[phaseLabel, color=phaseFind] at (-0.05, 1.10) {1.\ FIND};
\node[phaseSub] at (0.85, 1.10) {what's out there \& what to keep};

\node[phaseLabel, color=phaseUnderstand] at (4.90, 1.10) {2.\ UNDERSTAND};
\node[phaseSub] at (6.55, 1.10) {synthesis \& gaps};

\node[phaseLabel, color=phaseCreate] at (9.85, 1.10) {3.\ CREATE};
\node[phaseSub] at (11.05, 1.10) {draft, polish, slides};
